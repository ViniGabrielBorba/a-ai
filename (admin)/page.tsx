      ...
      <div className="container mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={onLogout}
              className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-lg transition duration-300 flex items-center gap-2"
            >
              <span>🚪</span>
              <span>Sair</span>
            </button>
          ...
          <div className="flex gap-4 border-b">
            <button
              ...
              className={`pb-2 px-4 font-semibold ${
                activeTab === 'orders' ? 'border-b-2 border-primary-600 text-primary-600' : 'text-gray-600'
              }`}
            >
              Pedidos
            </button>
            <button
              ...
              className={`pb-2 px-4 font-semibold ${
                activeTab === 'products' ? 'border-b-2 border-primary-600 text-primary-600' : 'text-gray-600'
              }`}
            >
              Produtos
            </button>
